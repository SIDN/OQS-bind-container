...
Then on some machine:
	...
	podman manifest create ghcr.io/sidn/oqs-bind-container:v4
	
	# Add individual builds
	podman manifest add --all ghcr.io/sidn/oqs-bind-container:v4 ghcr.io/sidn/oqs-bind-container:amd64
	podman manifest add --all ghcr.io/sidn/oqs-bind-container:v4 ghcr.io/sidn/oqs-bind-container:arm64
	# Merge all files
	podman manifest push ghcr.io/sidn/oqs-bind-container:v4
	podman manifest push ghcr.io/sidn/oqs-bind-container:v4 ghcr.io/sidn/oqs-bind-container:latest
